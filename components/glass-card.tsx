...
const GlassCard = React.forwardRef<HTMLDivElement, GlassCardProps>(
  ({ className = "", children, logoSrc, hideLogo = false, ...props }, ref) => {
    ...
    return (
      ...
      >
        <div
          className="relative h-full w-full rounded-[50px] bg-gradient-to-br from-zinc-900 to-black shadow-2xl transition-all duration-700 ease-out [transform-style:preserve-3d] [will-change:transform] [backface-visibility:hidden]"
          style={{
            transform: isHovered ? 'rotate3d(1, 1, 0, 20deg)' : 'rotate3d(0, 0, 0, 0deg)',
            boxShadow: isHovered
